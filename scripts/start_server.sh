...
OPENHAB_DIR="$SCRIPT_DIR/../openhab"
...
# config_server.sh asks about the add-ons; afterwards this step is disabled in-process.
#"$SCRIPT_DIR/config_server.sh" --keep && sed -i "s|^.*config_server\.sh.*--keep|#&|" "$0"
